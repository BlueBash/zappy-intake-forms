...
const formConfig: FormConfig = {
  ...
  "meta": {
    "product": "Anti-Aging Program",
    "form_name": "Anti-Aging Assessment",
    "version": "1.0.0",
    "language": "en-US"
  },
  "settings": {
  ...
  "screens": [
    // INTRO
    {
      ...
      "type": "content",
      "phase": "intro",
      "headline": "Welcome! Let's craft your anti-aging plan.",
      "body": "We'll explore your longevity goals, health history, and daily routine so we can personalize an anti-aging program that supports graceful aging. Takes about 10 minutes.",
      "cta_primary": {
        "label": "Let's Begin"
      },
    ...
    },
    {
      ...
      "options": [],
      "required": true,
      "next": "aa.medical_allergies"
    },

    // MEDICAL HISTORY
    {
      "id": "aa.medical_allergies",
      "type": "text",
      "phase": "intake",
      "title": "Medication Allergies",
      "help_text": "Example: 'Penicillin'",
      "placeholder": "List any medication allergies",
      "next": "aa.health_conditions"
    },
    {
      "id": "aa.health_conditions",
      "type": "multi_select",
      "phase": "intake",
      ...
      "next": "aa.other_conditions"
    },
    {
      "id": "aa.other_conditions",
      "type": "text",
      "phase": "intake",
      ...
      "next": "aa.current_medications"
    },
    {
      "id": "aa.current_medications",
      "type": "text",
      "phase": "intake",
      "title": "Current Medications & Dosages",
      "help_text": "Example: 'Omega-3 - 1000 mg daily'.",
      "placeholder": "List current medications and dosages",
      "next": "aa.recent_screenings"
    },
    {
      "id": "aa.recent_screenings",
      "type": "multi_select",
      "phase": "intake",
      ...
      "next_logic": [
        {
          ...
          "go_to": "aa.recent_screenings_other"
        },
        {
          "else": "aa.exercise_routine"
        }
      ]
    },
    {
      "id": "aa.recent_screenings_other",
      "type": "text",
      "phase": "intake",
      "title": "Other Longevity Markers",
      "placeholder": "List any additional markers or tests",
      "required": true,
      "next": "aa.exercise_routine"
    },

    // LIFESTYLE
    {
      "id": "aa.exercise_routine",
      "type": "single_select",
      "phase": "intake",
      ...
      "next_logic": [
        {
          "if": "answer == 'other'",
          "go_to": "aa.exercise_other"
        },
        {
          "else": "aa.nutritional_focus"
        }
      ]
    },
    {
      "id": "aa.exercise_other",
      "type": "text",
      "phase": "intake",
      "title": "Tell us more about your routine",
      "required": true,
      "next": "aa.nutritional_focus"
    },
    {
      "id": "aa.nutritional_focus",
      "type": "single_select",
      "phase": "intake",
      ...
      "next_logic": [
        {
          "if": "answer == 'other'",
          "go_to": "aa.nutritional_focus_other"
        },
        {
          "else": "aa.diet_history"
        }
      ]
    },
    {
      "id": "aa.nutritional_focus_other",
      "type": "text",
      "phase": "intake",
      "title": "Describe your nutrition approach",
      "required": true,
      "next": "aa.diet_history"
    },
    {
      "id": "aa.diet_history",
      "type": "text",
      ...
      "next": "aa.alcohol_consumption"
    },
    {
      "id": "aa.alcohol_consumption",
      "type": "single_select",
      "phase": "intake",
      ...
      "next": "aa.caffeine_intake"
    },
    {
      "id": "aa.caffeine_intake",
      "type": "single_select",
      "phase": "intake",
      ...
      "next_logic": [
        {
          "if": "answer == 'other'",
          "go_to": "aa.caffeine_details"
        },
        {
          "else": "aa.smoking_habits"
        }
      ]
    },
    {
      "id": "aa.caffeine_details",
      "type": "text",
      "phase": "intake",
      "title": "Tell us about your caffeine habits",
      "required": true,
      "next": "aa.smoking_habits"
    },
    {
      "id": "aa.smoking_habits",
      "type": "single_select",
      "phase": "intake",
    ...
    },
    {
      ...
      "next": "aa.medication_experience"
    },
    {
      "id": "aa.medication_experience",
      "type": "text",
      "phase": "intake",
      "title": "Medication Experience (if applicable)",
      "placeholder": "Share any experience with anti-aging or longevity therapies",
      "next": "aa.safety_intro"
    },
    ...
    // SAFETY
    {
      ...
      "next": "aa.safety_checklist"
    },
    {
      "id": "aa.safety_checklist",
      "type": "multi_select",
      "phase": "intake",
      ...
      "next_logic": [
        {
          ...
          "go_to": "aa.additional_health_details"
        },
        {
          "else": "aa.safety_details"
        }
      ]
    },
    {
      "id": "aa.safety_details",
      "type": "text",
      "phase": "intake",
      ...
      "required": true,
      "next": "aa.additional_health_details"
    },
    {
      "id": "aa.additional_health_details",
      "type": "text",
      "phase": "intake",
      "title": "Any additional concerns or health details?",
      "placeholder": "Share anything else our clinical team should know",
      "next": "aa.supplements_intro"
    },

    // SUPPLEMENTS
    {
      "id": "aa.supplements_intro",
      "type": "content",
      "phase": "intake",
      "headline": "Tell us about supplements and preferences",
      "body": "Understanding your supplement history helps us recommend the right longevity tools.",
      "cta_primary": {
        "label": "Continue"
      },
      "next": "aa.supplements_used"
    },
    {
      "id": "aa.supplements_used",
      "type": "single_select",
      "phase": "intake",
      ...
      "next_logic": [
        {
          "if": "answer == 'yes'",
          "go_to": "aa.supplements_current"
        },
        {
          "else": "aa.supplement_preferences"
        }
      ]
    },
    {
      "id": "aa.supplements_current",
      "type": "single_select",
      "phase": "intake",
      ...
      "next_logic": [
        {
          "if": "answer == 'yes'",
          "go_to": "aa.supplements_experience"
        },
        {
          "else": "aa.supplement_preferences"
        }
    ...
    },
    {
      ...
      "required": true,
      "next": "aa.supplement_conditions"
    },
    {
      "id": "aa.supplement_conditions",
      "type": "multi_select",
      "phase": "intake",
      ...
      "next_logic": [
        {
          "if": "answer contains 'none'",
          "go_to": "aa.additional_notes"
        },
        {
          "else": "aa.supplement_condition_details"
        }
      ]
    },
    {
      "id": "aa.supplement_condition_details",
      "type": "text",
      "phase": "intake",
      ...
      "required": true,
      "next": "aa.additional_notes"
    },
    {
      "id": "aa.additional_notes",
      "type": "text",
      "phase": "intake",
    ...
    },
    {
      ...
      "next_steps": [
        ...
        { "icon": "→", "icon_name": "plan", "label": "Personalized anti-aging plan (48 hrs)", "status": "pending" },
  ...
  "provider_packet": {
    "include_fields": [
      ...
      "country",
      "demographics.state",
      "aa.medical_allergies",
      "aa.health_conditions",
      "aa.other_conditions",
      "aa.current_medications",
      "aa.recent_screenings",
      "aa.recent_screenings_other",
      "aa.exercise_routine",
      "aa.nutritional_focus",
      "aa.diet_history",
      "aa.alcohol_consumption",
      "aa.caffeine_intake",
      "aa.smoking_habits",
      "aa.sleep_hours",
      "aa.medication_experience",
      "aa.safety_checklist",
      "aa.additional_health_details",
      "aa.supplements_used",
      "aa.supplements_current",
      "aa.supplements_experience",
      "aa.supplement_preferences",
      "aa.supplement_conditions",
      "aa.supplement_condition_details",
      "aa.additional_notes",
      "aa.referral_source",
      "selected_medication",
      "selected_plan",
    ...
    "summary_template":
      ...
      "MEDICAL: Allergies {aa.medical_allergies} | Conditions {aa.health_conditions} | Medications {aa.current_medications}\n" +
      "LIFESTYLE: Exercise {aa.exercise_routine} | Nutrition {aa.nutritional_focus} | Alcohol {aa.alcohol_consumption} | Sleep {aa.sleep_hours} hrs\n" +
      "SUPPLEMENTS: History {aa.supplements_used}/{aa.supplements_current} | Preferences {aa.supplement_preferences}",
    "risk_stratification": {
      "critical": [],
      "high": [],
      "medium": [],
