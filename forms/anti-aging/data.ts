...
const formConfig: FormConfig = {
  ...
  "screens": [
    ...
    },
    {
      ...
      "help_text": "Understanding your concerns helps us personalize your program",
      "options": [
    ...
    },
    {
      ...
      "post_screen_note": "This helps us understand your starting point for longevity optimization.",
      "fields": [
        [
          {
            "id": "height_ft",
        ...
        },
        {
          ...
          "required": true,
          "options": [
            { "value": "excellent", "label": "Excellent - Very few health concerns" },
            ...
            { "value": "declining", "label": "Declining - Noticeable health changes with age" }
          ]
        }
      ],
      "calculations": [
    ...
    // Additional Safety Screening
    {
      ...
      "options": [
        ...
        { "value": "growth_hormone_contraindication", "label": "Contraindication to growth hormone therapy" },
    ...
    },
    {
      ...
      "help_text": "Share any additional health information, concerns, or longevity goals that would help us provide the best care.",
      "placeholder": "Additional medical history, health concerns, or anti-aging goals...",
      "multiline": true,
      "rows": 6,
      "required": false,
    ...
    },
    {
      ...
      "help_text": "This includes peptides, hormones, or other advanced treatments",
      "auto_advance": true,
      "required": true,
      "options": [
        { "value": "never", "label": "No, never used these therapies" },
        { "value": "yes", "label": "Yes, I have experience with longevity treatments" }
      ],
      "next_logic": [
        {
          "if": "answer == 'yes'",
    ...
    },
    {
      ...
      "help_text": "Include which therapies you've used, for how long, results, and any side effects",
      "placeholder": "Example: Used NAD+ IV therapy for 6 months, noticed increased energy and better sleep, no side effects",
      "multiline": true,
      "rows": 6,
      "required": true,
    ...
    },
    {
      ...
      "next_steps": [
        ...
        { "icon": "→", "icon_name": "journey", "label": "Start your longevity journey", "status": "pending" }
      ],
      "cta_primary": {
