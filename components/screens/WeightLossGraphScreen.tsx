...
export default function WeightLossGraph({ companyName = 'Zappy', className = '', startingWeight, highestWeight, goalWeight }: WeightLossGraphProps) {
  ...
  return (
    <div className={`w-full overflow-visible ${className}`}>
      ...
      >
        ...
        <defs>
          {/* Background gradient - much lighter */}
          <linearGradient id="bgGradient" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#FFF5F2" />
            <stop offset="100%" stopColor="#FFEFEB" />
          </linearGradient>
        ...
        {/* WITH treatment label - MUCH BIGGER */}
        <motion.g
        ...
        {/* WITHOUT treatment label - MUCH BIGGER */}
        <motion.text
          x={xScale(12) - 170}
          y={yScale(96) + 28}
          fill="#666"
