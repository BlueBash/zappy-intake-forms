...
import { ScreenProps, NumberScreen as NumberScreenType } from '../../types';
import ScreenLayout from '../common/ScreenLayout';
import Input from '../ui/Input';
import NavigationButtons from '../common/NavigationButtons';

export default function NumberScreen({ screen, answers, updateAnswer, onSubmit, showBack, onBack }: ScreenProps & { screen: NumberScreenType }) {
